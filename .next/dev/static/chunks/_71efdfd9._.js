...
var PATHROUTES = /*#__PURE__*/ function(PATHROUTES) {
    ...
    PATHROUTES["COACH_CHAT"] = "/coach/chat";
    PATHROUTES["USERS_CHAT"] = "/users/chat";
    return PATHROUTES;
}({});
...
"[project]/utils/Navigation/navAdmin.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const navAdmin = [
    ...
    },
    {
        ...
        route: __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$PathRoutes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PATHROUTES"].DASHBOARD
    }
];
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/utils/Navigation/navCoach.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const navCoach = [
    ...
    },
    {
        id: 3,
        nameToRender: "Chat",
        route: __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$PathRoutes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PATHROUTES"].COACH_CHAT
    }
];
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/utils/Navigation/navPublic.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/utils/Navigation/navUsers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$Navigation$2f$navAdmin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/Navigation/navAdmin.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$Navigation$2f$navCoach$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/Navigation/navCoach.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$Navigation$2f$navPublic$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/Navigation/navPublic.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$Navigation$2f$navUsers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/Navigation/navUsers.ts [app-client] (ecmascript)");
;
...
const NavBarComponent = ()=>{
    ...
    let navItems = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$Navigation$2f$navPublic$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["navPublic"];
    if (role === "Admin") {
        navItems = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$Navigation$2f$navAdmin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["navAdmin"];
    } else if (role === "Coach") {
        navItems = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$Navigation$2f$navCoach$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["navCoach"];
    } else if (role === "user") {
        navItems = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$Navigation$2f$navUsers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["navUser"];
    }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        href: __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$PathRoutes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PATHROUTES"].HOME,
...
const getConversationsByRole = async (role, id, token)=>{
    const endpoint = role === "Coach" ? `/chat/conversations/coach/${id}` : `/conversations/user/${id}`;
    const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3030")}${endpoint}`, {
        headers: {
...
const getMessagesByConversation = async (userId, conversationId, token)=>{
    const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3030")}/chat/conversations/${conversationId}/messages?userId=${userId}`, {
        headers: {
            Authorization: `Bearer ${token}`
        }
    });
...
const createConversation = async (coachId, token)=>{
    const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3030")}/conversations`, {
        method: "POST",
        headers: {
...
const getAccesChat = async (token, userId)=>{
    const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3030")}/chat/access/${userId}`, {
        headers: {
            Authorization: `Bearer ${token}`
        }
    });
...
const closeChat = async (conversationId, token)=>{
    try {
        const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3030")}/chat/conversations/${conversationId}/close`, {
            method: "PATCH",
            headers: {
                Authorization: `Bearer ${token}`
            }
...
const getCoachConversations = async (coachId, token)=>{
    const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3030")}/chat/conversations/coach/${coachId}`, {
        headers: {
            Authorization: `Bearer ${token}`
        }
    });
    if (!res.ok) {
        ...
        throw new Error(error.message || "Error obteniendo conversaciones del coach");
    }
    return res.json();
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
const ChatProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatProvider.useEffect": ()=>{
            ...
            const socketInstance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$socket$2e$io$2d$client$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["io"])(`${("TURBOPACK compile-time value", "http://localhost:3030")}/chat`, {
                query: {
                    userId
                }
            });
        ...
        "ChatProvider.useEffect": ()=>{
            ...
            const loadConversations = {
                "ChatProvider.useEffect.loadConversations": async ()=>{
                    ...
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$chat$2e$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getConversationsByRole"])(role, userId, dataUser.token);
...
function ChatWindow() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatWindow.useEffect": ()=>{
            if (!dataUser) return;
            const initChat = {
                "ChatWindow.useEffect.initChat": async ()=>{
                    try {
                        const role = dataUser.user.role;
                        const userId = dataUser.user.id;
                        const token = dataUser.token;
                        if (role === "user") {
                            const access = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$chat$2e$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAccesChat"])(token, userId);
                            if (!access) {
                                setLoading(false);
                                return;
                            }
                        }
                        const conversations = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$chat$2e$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getConversationsByRole"])(role, userId, token);
                        if (conversations.length > 0) {
                            const conversation = conversations[0];
                            setSelectedConversation(conversation);
                            const msgs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$chat$2e$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMessagesByConversation"])(userId, conversation.id, token);
                            const formattedMessages = msgs.map({
                                "ChatWindow.useEffect.initChat.formattedMessages": (msg)=>({
                                        id: msg.id,
                                        content: msg.content,
                                        sender: msg.senderId === userId ? currentUserRole : currentUserRole === "user" ? "coach" : "user",
                                        createdAt: new Date(msg.createdAt).toLocaleTimeString([], {
                                            hour: "2-digit",
                                            minute: "2-digit"
                                        })
                                    })
                            }["ChatWindow.useEffect.initChat.formattedMessages"]);
...
_s(ChatWindow, "9BHGK6IMBey7YD0xCrWjJ7LFBHg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=_71efdfd9._.js.map