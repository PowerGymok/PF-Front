...
const ChatWindow = () => {
  ...
  return (
    <div className="w-[380px] h-[560px] bg-white rounded-2xl shadow-2xl border border-gray-200 flex overflow-hidden">
      ...
      <div className="w-[150px] border-r border-gray-200 bg-gray-50 flex flex-col">
            ...
            conversations.map((conversation) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left px-3 py-3 border-b border-gray-100 text-xs transition cursor-pointer ${
