...
export default async function MembershipDetailPage({ params }: Props) {
  ...
  const m = (await GetMembershipById(id)) as MembershipAdminResponse;
      ...
      <div style={styles.card}>
        ...
        <div style={styles.cardHeader}>
          ...
          <span
            style={{
              ...styles.badge,
              ...(m.isActive ? styles.badgeActive : styles.badgeInactive),
            }}
          >
...
const styles: Record<string, React.CSSProperties> = {
  ...
  name: { margin: 0, fontSize: "1.3rem", fontWeight: 700, color: "#fff" },
  description: {
    margin: "0.4rem 0 0",
    fontSize: "0.875rem",
  ...
  metric: { display: "flex", flexDirection: "column", gap: "0.3rem" },
  metricLabel: {
    fontSize: "0.7rem",
    fontWeight: 600,
    color: "rgba(255,255,255,0.3)",
  ...
  benefitsGrid: { display: "flex", flexDirection: "column", gap: "0.6rem" },
  benefit: { display: "flex", alignItems: "center", gap: "0.6rem" },
  ...
  benefitText: { fontSize: "0.875rem", color: "rgba(255,255,255,0.65)" },
  cardFooter: {
    padding: "1.25rem 1.75rem",
    display: "flex",
